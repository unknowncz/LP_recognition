...
register_coco_instances("license_plates", {}, f"{__file__}\\..\\train\\_annotations.coco.json", f"{__file__}\\..\\train")
register_coco_instances("license_plates_valid", {}, f"{__file__}\\..\\valid\\_annotations.coco.json", f"{__file__}\\..\\valid")
register_coco_instances("license_plates_test", {}, f"{__file__}\\..\\test\\_annotations.coco.json", f"{__file__}\\..\\test")
...
cfg.OUTPUT_DIR = f"{__file__}\\..\\output"
...
def test():
    ...
    for d in random.sample(dataset_dicts, 12):
        ...
        imshow(v.get_image())
    evaluator = COCOEvaluator("license_plates_test", cfg, False, output_dir="./output/")
