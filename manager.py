...
class taskDistributor:
    ...
    """
    def __init__(self, logger=logging.getLogger(), outputQueue=mp.Queue(), inputQueue=mp.Queue(5), successCallback=lambda *_:None):
        ...
        Args:
            ...
            inputQueue (mp.Queue, optional): Will contain the camera input tasks. Always limit the size when changing from default. Defaults to mp.Queue(5).
        """
        self.config = config
        self.logger = logger
